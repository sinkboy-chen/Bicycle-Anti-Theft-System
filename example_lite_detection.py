...
if __name__ == "__main__":
    ...
    parser.add_argument("-image", help="detect on image", default=r"./test.jpg", type=str)
    parser.add_argument("-video", action="store_true", help="detect on CAM", default=False)
    ...
    if args.video:
        ...
        while True:
            ...
            if len(boxes) > 0:
                for box in boxes:
                    ...
                    cv2.putText(img, "%.2f" % score, (x1, y1 - 5), 0, 0.7, (0, 255, 0), 2)
        ...
        if len(boxes) > 0:
            for box in boxes:
                ...
                cv2.putText(ori_img, "%.2f" % score, (x1, y1 - 5), 0, 0.7, (0, 255, 0), 2)
